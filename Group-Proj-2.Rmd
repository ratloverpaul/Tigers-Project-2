...
The regression model developed to predict booking status achieved an accuracy of 80%, meaning it correctly identified the booking status for 80% of the cases in the dataset. Accuracy is a measure of the overall performance of the model, showing how well it predicts both canceled and non-canceled bookings. Sensitivity was 64%, indicating that the model correctly identified 64% of actual cancellations. This metric is crucial when it's important to capture most cancellation cases. Specificity was 88%, meaning the model accurately identified 88% of non-canceled bookings. High specificity indicates that the model is effective at minimizing false positives, like it rarely predicts a booking as canceled when it isn’t. Together, these metrics show that the model is well-balanced, with a strong ability to accurately classify non-cancellations and a reasonable ability to capture cancellations, making it a valuable tool for understanding and predicting booking outcomes.
